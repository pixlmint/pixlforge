...
import type { AcceptRepoTransferData, AcceptRepoTransferErrors, AcceptRepoTransferResponses, ActionRunData, ActionRunErrors, ActionRunResponses, ActivitypubInstanceActorData, ActivitypubInstanceActorInboxData, ActivitypubInstanceActorInboxResponses, ActivitypubInstanceActorOutboxData, ActivitypubInstanceActorOutboxResponses, ActivitypubInstanceActorResponses, ActivitypubPersonActivityData, ActivitypubPersonActivityNoteData, ActivitypubPersonActivityNoteResponses, ActivitypubPersonActivityResponses, ActivitypubPersonData, ActivitypubPersonFeedData, ActivitypubPersonFeedErrors, ActivitypubPersonFeedResponses, ActivitypubPersonInboxData, ActivitypubPersonInboxResponses, ActivitypubPersonResponses, ActivitypubRepositoryData, ActivitypubRepositoryInboxData, ActivitypubRepositoryInboxResponses, ActivitypubRepositoryOutboxData, ActivitypubRepositoryOutboxResponses, ActivitypubRepositoryResponses, AdminAddRuleToQuotaGroupData, AdminAddRuleToQuotaGroupErrors, AdminAddRuleToQuotaGroupResponses, AdminAddUserToQuotaGroupData, AdminAddUserToQuotaGroupErrors, AdminAddUserToQuotaGroupResponses, AdminAdoptRepositoryData, AdminAdoptRepositoryErrors, AdminAdoptRepositoryResponses, AdminCreateHookData, AdminCreateHookResponses, AdminCreateOrgData, AdminCreateOrgErrors, AdminCreateOrgResponses, AdminCreatePublicKeyData, AdminCreatePublicKeyErrors, AdminCreatePublicKeyResponses, AdminCreateQuotaGroupData, AdminCreateQuotaGroupErrors, AdminCreateQuotaGroupResponses, AdminCreateQuotaRuleData, AdminCreateQuotaRuleErrors, AdminCreateQuotaRuleResponses, AdminCreateRepoData, AdminCreateRepoErrors, AdminCreateRepoResponses, AdminCreateUserData, AdminCreateUserErrors, AdminCreateUserResponses, AdminCronListData, AdminCronListErrors, AdminCronListResponses, AdminCronRunData, AdminCronRunErrors, AdminCronRunResponses, AdminDeleteHookData, AdminDeleteHookResponses, AdminDeleteQuotaGroupData, AdminDeleteQuotaGroupErrors, AdminDeleteQuotaGroupResponses, AdminDeleteQuotaRuleData, AdminDeleteQuotaRuleErrors, AdminDeleteQuotaRuleResponses, AdminDeleteUnadoptedRepositoryData, AdminDeleteUnadoptedRepositoryErrors, AdminDeleteUnadoptedRepositoryResponses, AdminDeleteUserData, AdminDeleteUserEmailsData, AdminDeleteUserEmailsErrors, AdminDeleteUserEmailsResponses, AdminDeleteUserErrors, AdminDeleteUserPublicKeyData, AdminDeleteUserPublicKeyErrors, AdminDeleteUserPublicKeyResponses, AdminDeleteUserResponses, AdminEditHookData, AdminEditHookResponses, AdminEditQuotaRuleData, AdminEditQuotaRuleErrors, AdminEditQuotaRuleResponses, AdminEditUserData, AdminEditUserErrors, AdminEditUserResponses, AdminGetActionRunJobsData, AdminGetActionRunJobsErrors, AdminGetActionRunJobsResponses, AdminGetAllEmailsData, AdminGetAllEmailsErrors, AdminGetAllEmailsResponses, AdminGetAllOrgsData, AdminGetAllOrgsErrors, AdminGetAllOrgsResponses, AdminGetHookData, AdminGetHookResponses, AdminGetQuotaGroupData, AdminGetQuotaGroupErrors, AdminGetQuotaGroupResponses, AdminGetQuotaRuleData, AdminGetQuotaRuleErrors, AdminGetQuotaRuleResponses, AdminGetRegistrationTokenData, AdminGetRegistrationTokenResponses, AdminGetRunnerRegistrationTokenData, AdminGetRunnerRegistrationTokenResponses, AdminGetUserQuotaData, AdminGetUserQuotaErrors, AdminGetUserQuotaResponses, AdminListHooksData, AdminListHooksResponses, AdminListQuotaGroupsData, AdminListQuotaGroupsErrors, AdminListQuotaGroupsResponses, AdminListQuotaRulesData, AdminListQuotaRulesErrors, AdminListQuotaRulesResponses, AdminListUserEmailsData, AdminListUserEmailsErrors, AdminListUserEmailsResponses, AdminListUsersInQuotaGroupData, AdminListUsersInQuotaGroupErrors, AdminListUsersInQuotaGroupResponses, AdminRemoveRuleFromQuotaGroupData, AdminRemoveRuleFromQuotaGroupErrors, AdminRemoveRuleFromQuotaGroupResponses, AdminRemoveUserFromQuotaGroupData, AdminRemoveUserFromQuotaGroupErrors, AdminRemoveUserFromQuotaGroupResponses, AdminRenameUserData, AdminRenameUserErrors, AdminRenameUserResponses, AdminSearchEmailsData, AdminSearchEmailsErrors, AdminSearchEmailsResponses, AdminSearchRunJobsData, AdminSearchRunJobsErrors, AdminSearchRunJobsResponses, AdminSearchUsersData, AdminSearchUsersErrors, AdminSearchUsersResponses, AdminSetUserQuotaGroupsData, AdminSetUserQuotaGroupsErrors, AdminSetUserQuotaGroupsResponses, AdminUnadoptedListData, AdminUnadoptedListErrors, AdminUnadoptedListResponses, CreateCurrentUserRepoData, CreateCurrentUserRepoErrors, CreateCurrentUserRepoResponses, CreateForkData, CreateForkErrors, CreateForkResponses, CreateOrgRepoData, CreateOrgRepoDeprecatedData, CreateOrgRepoDeprecatedErrors, CreateOrgRepoDeprecatedResponses, CreateOrgRepoErrors, CreateOrgRepoResponses, CreateOrgVariableData, CreateOrgVariableErrors, CreateOrgVariableResponses, CreateRepoVariableData, CreateRepoVariableErrors, CreateRepoVariableResponses, CreateUserVariableData, CreateUserVariableErrors, CreateUserVariableResponses, DeleteAdminRunnerData, DeleteAdminRunnerErrors, DeleteAdminRunnerResponses, DeleteOrgRunnerData, DeleteOrgRunnerErrors, DeleteOrgRunnerResponses, DeleteOrgSecretData, DeleteOrgSecretErrors, DeleteOrgSecretResponses, DeleteOrgVariableData, DeleteOrgVariableErrors, DeleteOrgVariableResponses, DeletePackageData, DeletePackageErrors, DeletePackageResponses, DeleteRepoRunnerData, DeleteRepoRunnerErrors, DeleteRepoRunnerResponses, DeleteRepoSecretData, DeleteRepoSecretErrors, DeleteRepoSecretResponses, DeleteRepoVariableData, DeleteRepoVariableErrors, DeleteRepoVariableResponses, DeleteUserRunnerData, DeleteUserRunnerErrors, DeleteUserRunnerResponses, DeleteUserSecretData, DeleteUserSecretErrors, DeleteUserSecretResponses, DeleteUserVariableData, DeleteUserVariableErrors, DeleteUserVariableResponses, DispatchWorkflowData, DispatchWorkflowErrors, DispatchWorkflowResponses, GenerateRepoData, GenerateRepoErrors, GenerateRepoResponses, GetAdminRunnerData, GetAdminRunnerErrors, GetAdminRunnerResponses, GetAdminRunnersData, GetAdminRunnersErrors, GetAdminRunnersResponses, GetAnnotatedTagData, GetAnnotatedTagErrors, GetAnnotatedTagResponses, GetBlobData, GetBlobErrors, GetBlobResponses, GetBlobsData, GetBlobsErrors, GetBlobsResponses, GetGeneralApiSettingsData, GetGeneralApiSettingsResponses, GetGeneralAttachmentSettingsData, GetGeneralAttachmentSettingsResponses, GetGeneralRepositorySettingsData, GetGeneralRepositorySettingsResponses, GetGeneralUiSettingsData, GetGeneralUiSettingsResponses, GetGitignoreTemplateInfoData, GetGitignoreTemplateInfoErrors, GetGitignoreTemplateInfoResponses, GetLabelTemplateInfoData, GetLabelTemplateInfoErrors, GetLabelTemplateInfoResponses, GetLicenseTemplateInfoData, GetLicenseTemplateInfoErrors, GetLicenseTemplateInfoResponses, GetNodeInfoData, GetNodeInfoResponses, GetOrgRunnerData, GetOrgRunnerErrors, GetOrgRunnerResponses, GetOrgRunnersData, GetOrgRunnersErrors, GetOrgRunnersResponses, GetOrgVariableData, GetOrgVariableErrors, GetOrgVariableResponses, GetOrgVariablesListData, GetOrgVariablesListErrors, GetOrgVariablesListResponses, GetPackageData, GetPackageErrors, GetPackageResponses, GetRepoRunnerData, GetRepoRunnerErrors, GetRepoRunnerResponses, GetRepoRunnersData, GetRepoRunnersErrors, GetRepoRunnersResponses, GetRepoVariableData, GetRepoVariableErrors, GetRepoVariableResponses, GetRepoVariablesListData, GetRepoVariablesListErrors, GetRepoVariablesListResponses, GetSigningKeyData, GetSigningKeyResponses, GetSshSigningKeyData, GetSshSigningKeyErrors, GetSshSigningKeyResponses, GetTreeData, GetTreeErrors, GetTreeResponses, GetUserRunnerData, GetUserRunnerErrors, GetUserRunnerResponses, GetUserRunnersData, GetUserRunnersErrors, GetUserRunnersResponses, GetUserSettingsData, GetUserSettingsErrors, GetUserSettingsResponses, GetUserVariableData, GetUserVariableErrors, GetUserVariableResponses, GetUserVariablesListData, GetUserVariablesListErrors, GetUserVariablesListResponses, GetVerificationTokenData, GetVerificationTokenErrors, GetVerificationTokenResponses, GetVersionData, GetVersionResponses, IssueAddLabelData, IssueAddLabelErrors, IssueAddLabelResponses, IssueAddSubscriptionData, IssueAddSubscriptionErrors, IssueAddSubscriptionResponses, IssueAddTimeData, IssueAddTimeErrors, IssueAddTimeResponses, IssueCheckSubscriptionData, IssueCheckSubscriptionErrors, IssueCheckSubscriptionResponses, IssueClearLabelsData, IssueClearLabelsErrors, IssueClearLabelsResponses, IssueCreateCommentData, IssueCreateCommentErrors, IssueCreateCommentResponses, IssueCreateIssueAttachmentData, IssueCreateIssueAttachmentErrors, IssueCreateIssueAttachmentResponses, IssueCreateIssueBlockingData, IssueCreateIssueBlockingErrors, IssueCreateIssueBlockingResponses, IssueCreateIssueCommentAttachmentData, IssueCreateIssueCommentAttachmentErrors, IssueCreateIssueCommentAttachmentResponses, IssueCreateIssueData, IssueCreateIssueDependenciesData, IssueCreateIssueDependenciesErrors, IssueCreateIssueDependenciesResponses, IssueCreateIssueErrors, IssueCreateIssueResponses, IssueCreateLabelData, IssueCreateLabelErrors, IssueCreateLabelResponses, IssueCreateMilestoneData, IssueCreateMilestoneErrors, IssueCreateMilestoneResponses, IssueDeleteCommentData, IssueDeleteCommentDeprecatedData, IssueDeleteCommentDeprecatedErrors, IssueDeleteCommentDeprecatedResponses, IssueDeleteCommentErrors, IssueDeleteCommentReactionData, IssueDeleteCommentReactionErrors, IssueDeleteCommentReactionResponses, IssueDeleteCommentResponses, IssueDeleteData, IssueDeleteErrors, IssueDeleteIssueAttachmentData, IssueDeleteIssueAttachmentErrors, IssueDeleteIssueAttachmentResponses, IssueDeleteIssueCommentAttachmentData, IssueDeleteIssueCommentAttachmentErrors, IssueDeleteIssueCommentAttachmentResponses, IssueDeleteIssueReactionData, IssueDeleteIssueReactionErrors, IssueDeleteIssueReactionResponses, IssueDeleteLabelData, IssueDeleteLabelErrors, IssueDeleteLabelResponses, IssueDeleteMilestoneData, IssueDeleteMilestoneErrors, IssueDeleteMilestoneResponses, IssueDeleteResponses, IssueDeleteStopWatchData, IssueDeleteStopWatchErrors, IssueDeleteStopWatchResponses, IssueDeleteSubscriptionData, IssueDeleteSubscriptionErrors, IssueDeleteSubscriptionResponses, IssueDeleteTimeData, IssueDeleteTimeErrors, IssueDeleteTimeResponses, IssueEditCommentData, IssueEditCommentDeprecatedData, IssueEditCommentDeprecatedErrors, IssueEditCommentDeprecatedResponses, IssueEditCommentErrors, IssueEditCommentResponses, IssueEditIssueAttachmentData, IssueEditIssueAttachmentErrors, IssueEditIssueAttachmentResponses, IssueEditIssueCommentAttachmentData, IssueEditIssueCommentAttachmentErrors, IssueEditIssueCommentAttachmentResponses, IssueEditIssueData, IssueEditIssueDeadlineData, IssueEditIssueDeadlineErrors, IssueEditIssueDeadlineResponses, IssueEditIssueErrors, IssueEditIssueResponses, IssueEditLabelData, IssueEditLabelErrors, IssueEditLabelResponses, IssueEditMilestoneData, IssueEditMilestoneErrors, IssueEditMilestoneResponses, IssueGetCommentData, IssueGetCommentErrors, IssueGetCommentReactionsData, IssueGetCommentReactionsErrors, IssueGetCommentReactionsResponses, IssueGetCommentResponses, IssueGetCommentsAndTimelineData, IssueGetCommentsAndTimelineErrors, IssueGetCommentsAndTimelineResponses, IssueGetCommentsData, IssueGetCommentsErrors, IssueGetCommentsResponses, IssueGetIssueAttachmentData, IssueGetIssueAttachmentErrors, IssueGetIssueAttachmentResponses, IssueGetIssueCommentAttachmentData, IssueGetIssueCommentAttachmentErrors, IssueGetIssueCommentAttachmentResponses, IssueGetIssueData, IssueGetIssueErrors, IssueGetIssueReactionsData, IssueGetIssueReactionsErrors, IssueGetIssueReactionsResponses, IssueGetIssueResponses, IssueGetLabelData, IssueGetLabelErrors, IssueGetLabelResponses, IssueGetLabelsData, IssueGetLabelsErrors, IssueGetLabelsResponses, IssueGetMilestoneData, IssueGetMilestoneErrors, IssueGetMilestoneResponses, IssueGetMilestonesListData, IssueGetMilestonesListErrors, IssueGetMilestonesListResponses, IssueGetRepoCommentsData, IssueGetRepoCommentsErrors, IssueGetRepoCommentsResponses, IssueListBlocksData, IssueListBlocksErrors, IssueListBlocksResponses, IssueListIssueAttachmentsData, IssueListIssueAttachmentsErrors, IssueListIssueAttachmentsResponses, IssueListIssueCommentAttachmentsData, IssueListIssueCommentAttachmentsErrors, IssueListIssueCommentAttachmentsResponses, IssueListIssueDependenciesData, IssueListIssueDependenciesErrors, IssueListIssueDependenciesResponses, IssueListIssuesData, IssueListIssuesErrors, IssueListIssuesResponses, IssueListLabelsData, IssueListLabelsErrors, IssueListLabelsResponses, IssuePostCommentReactionData, IssuePostCommentReactionErrors, IssuePostCommentReactionResponses, IssuePostIssueReactionData, IssuePostIssueReactionErrors, IssuePostIssueReactionResponses, IssueRemoveIssueBlockingData, IssueRemoveIssueBlockingErrors, IssueRemoveIssueBlockingResponses, IssueRemoveIssueDependenciesData, IssueRemoveIssueDependenciesErrors, IssueRemoveIssueDependenciesResponses, IssueRemoveLabelData, IssueRemoveLabelErrors, IssueRemoveLabelResponses, IssueReplaceLabelsData, IssueReplaceLabelsErrors, IssueReplaceLabelsResponses, IssueResetTimeData, IssueResetTimeErrors, IssueResetTimeResponses, IssueSearchIssuesData, IssueSearchIssuesErrors, IssueSearchIssuesResponses, IssueStartStopWatchData, IssueStartStopWatchErrors, IssueStartStopWatchResponses, IssueStopStopWatchData, IssueStopStopWatchErrors, IssueStopStopWatchResponses, IssueSubscriptionsData, IssueSubscriptionsErrors, IssueSubscriptionsResponses, IssueTrackedTimesData, IssueTrackedTimesErrors, IssueTrackedTimesResponses, LinkPackageData, LinkPackageErrors, LinkPackageResponses, ListActionRunsData, ListActionRunsErrors, ListActionRunsResponses, ListActionTasksData, ListActionTasksErrors, ListActionTasksResponses, ListForksData, ListForksErrors, ListForksResponses, ListGitignoresTemplatesData, ListGitignoresTemplatesResponses, ListLabelTemplatesData, ListLabelTemplatesResponses, ListLicenseTemplatesData, ListLicenseTemplatesResponses, ListPackageFilesData, ListPackageFilesErrors, ListPackageFilesResponses, ListPackagesData, ListPackagesErrors, ListPackagesResponses, MoveIssuePinData, MoveIssuePinErrors, MoveIssuePinResponses, NotifyGetListData, NotifyGetListResponses, NotifyGetRepoListData, NotifyGetRepoListResponses, NotifyGetThreadData, NotifyGetThreadErrors, NotifyGetThreadResponses, NotifyNewAvailableData, NotifyNewAvailableResponses, NotifyReadListData, NotifyReadListResponses, NotifyReadRepoListData, NotifyReadRepoListResponses, NotifyReadThreadData, NotifyReadThreadErrors, NotifyReadThreadResponses, OrgAddTeamMemberData, OrgAddTeamMemberErrors, OrgAddTeamMemberResponses, OrgAddTeamRepositoryData, OrgAddTeamRepositoryErrors, OrgAddTeamRepositoryResponses, OrgBlockUserData, OrgBlockUserErrors, OrgBlockUserResponses, OrgCheckQuotaData, OrgCheckQuotaErrors, OrgCheckQuotaResponses, OrgConcealMemberData, OrgConcealMemberErrors, OrgConcealMemberResponses, OrgCreateData, OrgCreateErrors, OrgCreateHookData, OrgCreateHookErrors, OrgCreateHookResponses, OrgCreateLabelData, OrgCreateLabelErrors, OrgCreateLabelResponses, OrgCreateResponses, OrgCreateTeamData, OrgCreateTeamErrors, OrgCreateTeamResponses, OrgDeleteAvatarData, OrgDeleteAvatarErrors, OrgDeleteAvatarResponses, OrgDeleteData, OrgDeleteErrors, OrgDeleteHookData, OrgDeleteHookErrors, OrgDeleteHookResponses, OrgDeleteLabelData, OrgDeleteLabelErrors, OrgDeleteLabelResponses, OrgDeleteMemberData, OrgDeleteMemberErrors, OrgDeleteMemberResponses, OrgDeleteResponses, OrgDeleteTeamData, OrgDeleteTeamErrors, OrgDeleteTeamResponses, OrgEditData, OrgEditErrors, OrgEditHookData, OrgEditHookErrors, OrgEditHookResponses, OrgEditLabelData, OrgEditLabelErrors, OrgEditLabelResponses, OrgEditResponses, OrgEditTeamData, OrgEditTeamErrors, OrgEditTeamResponses, OrgGetAllData, OrgGetAllResponses, OrgGetData, OrgGetErrors, OrgGetHookData, OrgGetHookErrors, OrgGetHookResponses, OrgGetLabelData, OrgGetLabelErrors, OrgGetLabelResponses, OrgGetQuotaData, OrgGetQuotaErrors, OrgGetQuotaResponses, OrgGetResponses, OrgGetRunnerRegistrationTokenData, OrgGetRunnerRegistrationTokenResponses, OrgGetTeamData, OrgGetTeamErrors, OrgGetTeamResponses, OrgGetUserPermissionsData, OrgGetUserPermissionsErrors, OrgGetUserPermissionsResponses, OrgIsMemberData, OrgIsMemberErrors, OrgIsMemberResponses, OrgIsPublicMemberData, OrgIsPublicMemberErrors, OrgIsPublicMemberResponses, OrgListActionsSecretsData, OrgListActionsSecretsErrors, OrgListActionsSecretsResponses, OrgListActivityFeedsData, OrgListActivityFeedsErrors, OrgListActivityFeedsResponses, OrgListBlockedUsersData, OrgListBlockedUsersResponses, OrgListCurrentUserOrgsData, OrgListCurrentUserOrgsErrors, OrgListCurrentUserOrgsResponses, OrgListHooksData, OrgListHooksErrors, OrgListHooksResponses, OrgListLabelsData, OrgListLabelsErrors, OrgListLabelsResponses, OrgListMembersData, OrgListMembersErrors, OrgListMembersResponses, OrgListPublicMembersData, OrgListPublicMembersErrors, OrgListPublicMembersResponses, OrgListQuotaArtifactsData, OrgListQuotaArtifactsErrors, OrgListQuotaArtifactsResponses, OrgListQuotaAttachmentsData, OrgListQuotaAttachmentsErrors, OrgListQuotaAttachmentsResponses, OrgListQuotaPackagesData, OrgListQuotaPackagesErrors, OrgListQuotaPackagesResponses, OrgListReposData, OrgListReposErrors, OrgListReposResponses, OrgListTeamActivityFeedsData, OrgListTeamActivityFeedsErrors, OrgListTeamActivityFeedsResponses, OrgListTeamMemberData, OrgListTeamMemberErrors, OrgListTeamMemberResponses, OrgListTeamMembersData, OrgListTeamMembersErrors, OrgListTeamMembersResponses, OrgListTeamRepoData, OrgListTeamRepoErrors, OrgListTeamRepoResponses, OrgListTeamReposData, OrgListTeamReposErrors, OrgListTeamReposResponses, OrgListTeamsData, OrgListTeamsErrors, OrgListTeamsResponses, OrgListUserOrgsData, OrgListUserOrgsErrors, OrgListUserOrgsResponses, OrgPublicizeMemberData, OrgPublicizeMemberErrors, OrgPublicizeMemberResponses, OrgRemoveTeamMemberData, OrgRemoveTeamMemberErrors, OrgRemoveTeamMemberResponses, OrgRemoveTeamRepositoryData, OrgRemoveTeamRepositoryErrors, OrgRemoveTeamRepositoryResponses, OrgSearchRunJobsData, OrgSearchRunJobsErrors, OrgSearchRunJobsResponses, OrgUnblockUserData, OrgUnblockUserErrors, OrgUnblockUserResponses, OrgUpdateAvatarData, OrgUpdateAvatarErrors, OrgUpdateAvatarResponses, PinIssueData, PinIssueErrors, PinIssueResponses, RegisterAdminRunnerData, RegisterAdminRunnerErrors, RegisterAdminRunnerResponses, RegisterOrgRunnerData, RegisterOrgRunnerErrors, RegisterOrgRunnerResponses, RegisterRepoRunnerData, RegisterRepoRunnerErrors, RegisterRepoRunnerResponses, RegisterUserRunnerData, RegisterUserRunnerErrors, RegisterUserRunnerResponses, RejectRepoTransferData, RejectRepoTransferErrors, RejectRepoTransferResponses, RenameOrgData, RenameOrgErrors, RenameOrgResponses, RenderMarkdownData, RenderMarkdownErrors, RenderMarkdownRawData, RenderMarkdownRawErrors, RenderMarkdownRawResponses, RenderMarkdownResponses, RenderMarkupData, RenderMarkupErrors, RenderMarkupResponses, RepoAddCollaboratorData, RepoAddCollaboratorErrors, RepoAddCollaboratorResponses, RepoAddFlagData, RepoAddFlagErrors, RepoAddFlagResponses, RepoAddPushMirrorData, RepoAddPushMirrorErrors, RepoAddPushMirrorResponses, RepoAddTeamData, RepoAddTeamErrors, RepoAddTeamResponses, RepoAddTopicData, RepoAddTopicErrors, RepoAddTopicResponses, RepoApplyDiffPatchData, RepoApplyDiffPatchErrors, RepoApplyDiffPatchResponses, RepoCancelScheduledAutoMergeData, RepoCancelScheduledAutoMergeErrors, RepoCancelScheduledAutoMergeResponses, RepoChangeFilesData, RepoChangeFilesErrors, RepoChangeFilesResponses, RepoCheckCollaboratorData, RepoCheckCollaboratorErrors, RepoCheckCollaboratorResponses, RepoCheckFlagData, RepoCheckFlagErrors, RepoCheckFlagResponses, RepoCheckTeamData, RepoCheckTeamErrors, RepoCheckTeamResponses, RepoCompareDiffData, RepoCompareDiffErrors, RepoCompareDiffResponses, RepoConvertData, RepoConvertErrors, RepoConvertResponses, RepoCreateBranchData, RepoCreateBranchErrors, RepoCreateBranchProtectionData, RepoCreateBranchProtectionErrors, RepoCreateBranchProtectionResponses, RepoCreateBranchResponses, RepoCreateFileData, RepoCreateFileErrors, RepoCreateFileResponses, RepoCreateHookData, RepoCreateHookErrors, RepoCreateHookResponses, RepoCreateKeyData, RepoCreateKeyErrors, RepoCreateKeyResponses, RepoCreatePullRequestData, RepoCreatePullRequestErrors, RepoCreatePullRequestResponses, RepoCreatePullReviewCommentData, RepoCreatePullReviewCommentErrors, RepoCreatePullReviewCommentResponses, RepoCreatePullReviewData, RepoCreatePullReviewErrors, RepoCreatePullReviewRequestsData, RepoCreatePullReviewRequestsErrors, RepoCreatePullReviewRequestsResponses, RepoCreatePullReviewResponses, RepoCreateReleaseAttachmentData, RepoCreateReleaseAttachmentErrors, RepoCreateReleaseAttachmentResponses, RepoCreateReleaseData, RepoCreateReleaseErrors, RepoCreateReleaseResponses, RepoCreateStatusData, RepoCreateStatusErrors, RepoCreateStatusResponses, RepoCreateTagData, RepoCreateTagErrors, RepoCreateTagProtectionData, RepoCreateTagProtectionErrors, RepoCreateTagProtectionResponses, RepoCreateTagResponses, RepoCreateWikiPageData, RepoCreateWikiPageErrors, RepoCreateWikiPageResponses, RepoDeleteAllFlagsData, RepoDeleteAllFlagsErrors, RepoDeleteAllFlagsResponses, RepoDeleteAvatarData, RepoDeleteAvatarErrors, RepoDeleteAvatarResponses, RepoDeleteBranchData, RepoDeleteBranchErrors, RepoDeleteBranchProtectionData, RepoDeleteBranchProtectionErrors, RepoDeleteBranchProtectionResponses, RepoDeleteBranchResponses, RepoDeleteCollaboratorData, RepoDeleteCollaboratorErrors, RepoDeleteCollaboratorResponses, RepoDeleteData, RepoDeleteErrors, RepoDeleteFileData, RepoDeleteFileErrors, RepoDeleteFileResponses, RepoDeleteFlagData, RepoDeleteFlagErrors, RepoDeleteFlagResponses, RepoDeleteGitHookData, RepoDeleteGitHookErrors, RepoDeleteGitHookResponses, RepoDeleteHookData, RepoDeleteHookErrors, RepoDeleteHookResponses, RepoDeleteKeyData, RepoDeleteKeyErrors, RepoDeleteKeyResponses, RepoDeletePullReviewCommentData, RepoDeletePullReviewCommentErrors, RepoDeletePullReviewCommentResponses, RepoDeletePullReviewData, RepoDeletePullReviewErrors, RepoDeletePullReviewRequestsData, RepoDeletePullReviewRequestsErrors, RepoDeletePullReviewRequestsResponses, RepoDeletePullReviewResponses, RepoDeletePushMirrorData, RepoDeletePushMirrorErrors, RepoDeletePushMirrorResponses, RepoDeleteReleaseAttachmentData, RepoDeleteReleaseAttachmentErrors, RepoDeleteReleaseAttachmentResponses, RepoDeleteReleaseByTagData, RepoDeleteReleaseByTagErrors, RepoDeleteReleaseByTagResponses, RepoDeleteReleaseData, RepoDeleteReleaseErrors, RepoDeleteReleaseResponses, RepoDeleteResponses, RepoDeleteTagData, RepoDeleteTagErrors, RepoDeleteTagProtectionData, RepoDeleteTagProtectionErrors, RepoDeleteTagProtectionResponses, RepoDeleteTagResponses, RepoDeleteTeamData, RepoDeleteTeamErrors, RepoDeleteTeamResponses, RepoDeleteTopicData, RepoDeleteTopicErrors, RepoDeleteTopicResponses, RepoDeleteWikiPageData, RepoDeleteWikiPageErrors, RepoDeleteWikiPageResponses, RepoDismissPullReviewData, RepoDismissPullReviewErrors, RepoDismissPullReviewResponses, RepoDownloadCommitDiffOrPatchData, RepoDownloadCommitDiffOrPatchErrors, RepoDownloadCommitDiffOrPatchResponses, RepoDownloadPullDiffOrPatchData, RepoDownloadPullDiffOrPatchErrors, RepoDownloadPullDiffOrPatchResponses, RepoEditBranchProtectionData, RepoEditBranchProtectionErrors, RepoEditBranchProtectionResponses, RepoEditData, RepoEditErrors, RepoEditGitHookData, RepoEditGitHookErrors, RepoEditGitHookResponses, RepoEditHookData, RepoEditHookErrors, RepoEditHookResponses, RepoEditPullRequestData, RepoEditPullRequestErrors, RepoEditPullRequestResponses, RepoEditReleaseAttachmentData, RepoEditReleaseAttachmentErrors, RepoEditReleaseAttachmentResponses, RepoEditReleaseData, RepoEditReleaseErrors, RepoEditReleaseResponses, RepoEditResponses, RepoEditTagProtectionData, RepoEditTagProtectionErrors, RepoEditTagProtectionResponses, RepoEditWikiPageData, RepoEditWikiPageErrors, RepoEditWikiPageResponses, RepoGetAllCommitsData, RepoGetAllCommitsErrors, RepoGetAllCommitsResponses, RepoGetArchiveData, RepoGetArchiveErrors, RepoGetArchiveResponses, RepoGetAssigneesData, RepoGetAssigneesErrors, RepoGetAssigneesResponses, RepoGetBranchData, RepoGetBranchErrors, RepoGetBranchProtectionData, RepoGetBranchProtectionErrors, RepoGetBranchProtectionResponses, RepoGetBranchResponses, RepoGetByIdData, RepoGetByIdErrors, RepoGetByIdResponses, RepoGetCombinedStatusByRefData, RepoGetCombinedStatusByRefErrors, RepoGetCombinedStatusByRefResponses, RepoGetCommitPullRequestData, RepoGetCommitPullRequestErrors, RepoGetCommitPullRequestResponses, RepoGetContentsData, RepoGetContentsErrors, RepoGetContentsListData, RepoGetContentsListErrors, RepoGetContentsListResponses, RepoGetContentsResponses, RepoGetData, RepoGetEditorConfigData, RepoGetEditorConfigErrors, RepoGetEditorConfigResponses, RepoGetErrors, RepoGetGitHookData, RepoGetGitHookErrors, RepoGetGitHookResponses, RepoGetHookData, RepoGetHookErrors, RepoGetHookResponses, RepoGetIssueConfigData, RepoGetIssueConfigErrors, RepoGetIssueConfigResponses, RepoGetIssueTemplatesData, RepoGetIssueTemplatesErrors, RepoGetIssueTemplatesResponses, RepoGetKeyData, RepoGetKeyErrors, RepoGetKeyResponses, RepoGetLanguagesData, RepoGetLanguagesErrors, RepoGetLanguagesResponses, RepoGetLatestReleaseData, RepoGetLatestReleaseErrors, RepoGetLatestReleaseResponses, RepoGetNoteData, RepoGetNoteErrors, RepoGetNoteResponses, RepoGetPullRequestByBaseHeadData, RepoGetPullRequestByBaseHeadErrors, RepoGetPullRequestByBaseHeadResponses, RepoGetPullRequestCommitsData, RepoGetPullRequestCommitsErrors, RepoGetPullRequestCommitsResponses, RepoGetPullRequestData, RepoGetPullRequestErrors, RepoGetPullRequestFilesData, RepoGetPullRequestFilesErrors, RepoGetPullRequestFilesResponses, RepoGetPullRequestResponses, RepoGetPullReviewCommentData, RepoGetPullReviewCommentErrors, RepoGetPullReviewCommentResponses, RepoGetPullReviewCommentsData, RepoGetPullReviewCommentsErrors, RepoGetPullReviewCommentsResponses, RepoGetPullReviewData, RepoGetPullReviewErrors, RepoGetPullReviewResponses, RepoGetPushMirrorByRemoteNameData, RepoGetPushMirrorByRemoteNameErrors, RepoGetPushMirrorByRemoteNameResponses, RepoGetRawFileData, RepoGetRawFileErrors, RepoGetRawFileOrLfsData, RepoGetRawFileOrLfsErrors, RepoGetRawFileOrLfsResponses, RepoGetRawFileResponses, RepoGetReleaseAttachmentData, RepoGetReleaseAttachmentErrors, RepoGetReleaseAttachmentResponses, RepoGetReleaseByTagData, RepoGetReleaseByTagErrors, RepoGetReleaseByTagResponses, RepoGetReleaseData, RepoGetReleaseErrors, RepoGetReleaseResponses, RepoGetRepoPermissionsData, RepoGetRepoPermissionsErrors, RepoGetRepoPermissionsResponses, RepoGetResponses, RepoGetReviewersData, RepoGetReviewersErrors, RepoGetReviewersResponses, RepoGetRunnerRegistrationTokenData, RepoGetRunnerRegistrationTokenResponses, RepoGetSingleCommitData, RepoGetSingleCommitErrors, RepoGetSingleCommitResponses, RepoGetTagData, RepoGetTagErrors, RepoGetTagProtectionData, RepoGetTagProtectionErrors, RepoGetTagProtectionResponses, RepoGetTagResponses, RepoGetWikiPageData, RepoGetWikiPageErrors, RepoGetWikiPageResponses, RepoGetWikiPageRevisionsData, RepoGetWikiPageRevisionsErrors, RepoGetWikiPageRevisionsResponses, RepoGetWikiPagesData, RepoGetWikiPagesErrors, RepoGetWikiPagesResponses, RepoListActionsSecretsData, RepoListActionsSecretsErrors, RepoListActionsSecretsResponses, RepoListActivityFeedsData, RepoListActivityFeedsErrors, RepoListActivityFeedsResponses, RepoListAllGitRefsData, RepoListAllGitRefsErrors, RepoListAllGitRefsResponses, RepoListBranchesData, RepoListBranchesResponses, RepoListBranchProtectionData, RepoListBranchProtectionResponses, RepoListCollaboratorsData, RepoListCollaboratorsErrors, RepoListCollaboratorsResponses, RepoListFlagsData, RepoListFlagsErrors, RepoListFlagsResponses, RepoListGitHooksData, RepoListGitHooksErrors, RepoListGitHooksResponses, RepoListGitRefsData, RepoListGitRefsErrors, RepoListGitRefsResponses, RepoListHooksData, RepoListHooksErrors, RepoListHooksResponses, RepoListKeysData, RepoListKeysErrors, RepoListKeysResponses, RepoListPinnedIssuesData, RepoListPinnedIssuesErrors, RepoListPinnedIssuesResponses, RepoListPinnedPullRequestsData, RepoListPinnedPullRequestsErrors, RepoListPinnedPullRequestsResponses, RepoListPullRequestsData, RepoListPullRequestsErrors, RepoListPullRequestsResponses, RepoListPullReviewsData, RepoListPullReviewsErrors, RepoListPullReviewsResponses, RepoListPushMirrorsData, RepoListPushMirrorsErrors, RepoListPushMirrorsResponses, RepoListReleaseAttachmentsData, RepoListReleaseAttachmentsErrors, RepoListReleaseAttachmentsResponses, RepoListReleasesData, RepoListReleasesErrors, RepoListReleasesResponses, RepoListStargazersData, RepoListStargazersErrors, RepoListStargazersResponses, RepoListStatusesByRefData, RepoListStatusesByRefErrors, RepoListStatusesByRefResponses, RepoListStatusesData, RepoListStatusesErrors, RepoListStatusesResponses, RepoListSubscribersData, RepoListSubscribersErrors, RepoListSubscribersResponses, RepoListTagProtectionData, RepoListTagProtectionResponses, RepoListTagsData, RepoListTagsErrors, RepoListTagsResponses, RepoListTeamsData, RepoListTeamsErrors, RepoListTeamsResponses, RepoListTopicsData, RepoListTopicsErrors, RepoListTopicsResponses, RepoMergePullRequestData, RepoMergePullRequestErrors, RepoMergePullRequestResponses, RepoMigrateData, RepoMigrateErrors, RepoMigrateResponses, RepoMirrorSyncData, RepoMirrorSyncErrors, RepoMirrorSyncResponses, RepoNewPinAllowedData, RepoNewPinAllowedErrors, RepoNewPinAllowedResponses, RepoPullRequestIsMergedData, RepoPullRequestIsMergedErrors, RepoPullRequestIsMergedResponses, RepoPushMirrorSyncData, RepoPushMirrorSyncErrors, RepoPushMirrorSyncResponses, RepoRemoveNoteData, RepoRemoveNoteErrors, RepoRemoveNoteResponses, RepoReplaceAllFlagsData, RepoReplaceAllFlagsErrors, RepoReplaceAllFlagsResponses, RepoSearchData, RepoSearchErrors, RepoSearchResponses, RepoSearchRunJobsData, RepoSearchRunJobsErrors, RepoSearchRunJobsResponses, RepoSetNoteData, RepoSetNoteErrors, RepoSetNoteResponses, RepoSigningKeyData, RepoSigningKeyResponses, RepoSubmitPullReviewData, RepoSubmitPullReviewErrors, RepoSubmitPullReviewResponses, RepoSyncForkBranchData, RepoSyncForkBranchErrors, RepoSyncForkBranchInfoData, RepoSyncForkBranchInfoErrors, RepoSyncForkBranchInfoResponses, RepoSyncForkBranchResponses, RepoSyncForkDefaultData, RepoSyncForkDefaultErrors, RepoSyncForkDefaultInfoData, RepoSyncForkDefaultInfoErrors, RepoSyncForkDefaultInfoResponses, RepoSyncForkDefaultResponses, RepoTestHookData, RepoTestHookErrors, RepoTestHookResponses, RepoTrackedTimesData, RepoTrackedTimesErrors, RepoTrackedTimesResponses, RepoTransferData, RepoTransferErrors, RepoTransferResponses, RepoUnDismissPullReviewData, RepoUnDismissPullReviewErrors, RepoUnDismissPullReviewResponses, RepoUpdateAvatarData, RepoUpdateAvatarErrors, RepoUpdateAvatarResponses, RepoUpdateBranchData, RepoUpdateBranchErrors, RepoUpdateBranchResponses, RepoUpdateFileData, RepoUpdateFileErrors, RepoUpdateFileResponses, RepoUpdatePullRequestData, RepoUpdatePullRequestErrors, RepoUpdatePullRequestResponses, RepoUpdateTopicsData, RepoUpdateTopicsErrors, RepoUpdateTopicsResponses, RepoValidateIssueConfigData, RepoValidateIssueConfigErrors, RepoValidateIssueConfigResponses, TeamSearchData, TeamSearchErrors, TeamSearchResponses, TopicSearchData, TopicSearchErrors, TopicSearchResponses, UnlinkPackageData, UnlinkPackageErrors, UnlinkPackageResponses, UnpinIssueData, UnpinIssueErrors, UnpinIssueResponses, UpdateOrgSecretData, UpdateOrgSecretErrors, UpdateOrgSecretResponses, UpdateOrgVariableData, UpdateOrgVariableErrors, UpdateOrgVariableResponses, UpdateRepoSecretData, UpdateRepoSecretErrors, UpdateRepoSecretResponses, UpdateRepoVariableData, UpdateRepoVariableErrors, UpdateRepoVariableResponses, UpdateUserSecretData, UpdateUserSecretErrors, UpdateUserSecretResponses, UpdateUserSettingsData, UpdateUserSettingsErrors, UpdateUserSettingsResponses, UpdateUserVariableData, UpdateUserVariableErrors, UpdateUserVariableResponses, UserAddEmailData, UserAddEmailErrors, UserAddEmailResponses, UserBlockUserData, UserBlockUserErrors, UserBlockUserResponses, UserCheckFollowingData, UserCheckFollowingErrors, UserCheckFollowingResponses, UserCheckQuotaData, UserCheckQuotaErrors, UserCheckQuotaResponses, UserCreateHookData, UserCreateHookErrors, UserCreateHookResponses, UserCreateOAuth2ApplicationData, UserCreateOAuth2ApplicationErrors, UserCreateOAuth2ApplicationResponses, UserCreateTokenData, UserCreateTokenErrors, UserCreateTokenResponses, UserCurrentCheckFollowingData, UserCurrentCheckFollowingErrors, UserCurrentCheckFollowingResponses, UserCurrentCheckStarringData, UserCurrentCheckStarringErrors, UserCurrentCheckStarringResponses, UserCurrentCheckSubscriptionData, UserCurrentCheckSubscriptionErrors, UserCurrentCheckSubscriptionResponses, UserCurrentDeleteFollowData, UserCurrentDeleteFollowErrors, UserCurrentDeleteFollowResponses, UserCurrentDeleteGpgKeyData, UserCurrentDeleteGpgKeyErrors, UserCurrentDeleteGpgKeyResponses, UserCurrentDeleteKeyData, UserCurrentDeleteKeyErrors, UserCurrentDeleteKeyResponses, UserCurrentDeleteStarData, UserCurrentDeleteStarErrors, UserCurrentDeleteStarResponses, UserCurrentDeleteSubscriptionData, UserCurrentDeleteSubscriptionErrors, UserCurrentDeleteSubscriptionResponses, UserCurrentGetGpgKeyData, UserCurrentGetGpgKeyErrors, UserCurrentGetGpgKeyResponses, UserCurrentGetKeyData, UserCurrentGetKeyErrors, UserCurrentGetKeyResponses, UserCurrentListFollowersData, UserCurrentListFollowersErrors, UserCurrentListFollowersResponses, UserCurrentListFollowingData, UserCurrentListFollowingErrors, UserCurrentListFollowingResponses, UserCurrentListGpgKeysData, UserCurrentListGpgKeysErrors, UserCurrentListGpgKeysResponses, UserCurrentListKeysData, UserCurrentListKeysErrors, UserCurrentListKeysResponses, UserCurrentListReposData, UserCurrentListReposErrors, UserCurrentListReposResponses, UserCurrentListStarredData, UserCurrentListStarredErrors, UserCurrentListStarredResponses, UserCurrentListSubscriptionsData, UserCurrentListSubscriptionsErrors, UserCurrentListSubscriptionsResponses, UserCurrentPostGpgKeyData, UserCurrentPostGpgKeyErrors, UserCurrentPostGpgKeyResponses, UserCurrentPostKeyData, UserCurrentPostKeyErrors, UserCurrentPostKeyResponses, UserCurrentPutFollowData, UserCurrentPutFollowErrors, UserCurrentPutFollowResponses, UserCurrentPutStarData, UserCurrentPutStarErrors, UserCurrentPutStarResponses, UserCurrentPutSubscriptionData, UserCurrentPutSubscriptionErrors, UserCurrentPutSubscriptionResponses, UserCurrentTrackedTimesData, UserCurrentTrackedTimesErrors, UserCurrentTrackedTimesResponses, UserDeleteAccessTokenData, UserDeleteAccessTokenErrors, UserDeleteAccessTokenResponses, UserDeleteAvatarData, UserDeleteAvatarErrors, UserDeleteAvatarResponses, UserDeleteEmailData, UserDeleteEmailErrors, UserDeleteEmailResponses, UserDeleteHookData, UserDeleteHookErrors, UserDeleteHookResponses, UserDeleteOAuth2ApplicationData, UserDeleteOAuth2ApplicationErrors, UserDeleteOAuth2ApplicationResponses, UserEditHookData, UserEditHookErrors, UserEditHookResponses, UserGetCurrentData, UserGetCurrentErrors, UserGetCurrentResponses, UserGetData, UserGetErrors, UserGetHeatmapDataData, UserGetHeatmapDataErrors, UserGetHeatmapDataResponses, UserGetHookData, UserGetHookErrors, UserGetHookResponses, UserGetOAuth2ApplicationData, UserGetOAuth2ApplicationErrors, UserGetOAuth2ApplicationResponses, UserGetOAuth2ApplicationsData, UserGetOAuth2ApplicationsErrors, UserGetOAuth2ApplicationsResponses, UserGetQuotaData, UserGetQuotaErrors, UserGetQuotaResponses, UserGetResponses, UserGetRunnerRegistrationTokenData, UserGetRunnerRegistrationTokenErrors, UserGetRunnerRegistrationTokenResponses, UserGetStopWatchesData, UserGetStopWatchesErrors, UserGetStopWatchesResponses, UserGetTokensData, UserGetTokensErrors, UserGetTokensResponses, UserListActivityFeedsData, UserListActivityFeedsErrors, UserListActivityFeedsResponses, UserListBlockedUsersData, UserListBlockedUsersErrors, UserListBlockedUsersResponses, UserListEmailsData, UserListEmailsErrors, UserListEmailsResponses, UserListFollowersData, UserListFollowersErrors, UserListFollowersResponses, UserListFollowingData, UserListFollowingErrors, UserListFollowingResponses, UserListGpgKeysData, UserListGpgKeysErrors, UserListGpgKeysResponses, UserListHooksData, UserListHooksErrors, UserListHooksResponses, UserListKeysData, UserListKeysErrors, UserListKeysResponses, UserListQuotaArtifactsData, UserListQuotaArtifactsErrors, UserListQuotaArtifactsResponses, UserListQuotaAttachmentsData, UserListQuotaAttachmentsErrors, UserListQuotaAttachmentsResponses, UserListQuotaPackagesData, UserListQuotaPackagesErrors, UserListQuotaPackagesResponses, UserListReposData, UserListReposErrors, UserListReposResponses, UserListStarredData, UserListStarredErrors, UserListStarredResponses, UserListSubscriptionsData, UserListSubscriptionsErrors, UserListSubscriptionsResponses, UserListTeamsData, UserListTeamsErrors, UserListTeamsResponses, UserSearchData, UserSearchResponses, UserSearchRunJobsData, UserSearchRunJobsErrors, UserSearchRunJobsResponses, UserTrackedTimesData, UserTrackedTimesErrors, UserTrackedTimesResponses, UserUnblockUserData, UserUnblockUserErrors, UserUnblockUserResponses, UserUpdateAvatarData, UserUpdateAvatarErrors, UserUpdateAvatarResponses, UserUpdateOAuth2ApplicationData, UserUpdateOAuth2ApplicationErrors, UserUpdateOAuth2ApplicationResponses, UserVerifyGpgKeyData, UserVerifyGpgKeyErrors, UserVerifyGpgKeyResponses } from './types.gen';
 ...
 */
export const getAdminRunners = <ThrowOnError extends boolean = false>(options?: Options<GetAdminRunnersData, ThrowOnError>) => (options?.client ?? client).get<GetAdminRunnersResponses, GetAdminRunnersErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const registerAdminRunner = <ThrowOnError extends boolean = false>(options?: Options<RegisterAdminRunnerData, ThrowOnError>) => (options?.client ?? client).post<RegisterAdminRunnerResponses, RegisterAdminRunnerErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 * Get action run jobs
 */
export const adminGetActionRunJobs = <ThrowOnError extends boolean = false>(options?: Options<AdminGetActionRunJobsData, ThrowOnError>) => (options?.client ?? client).get<AdminGetActionRunJobsResponses, AdminGetActionRunJobsErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const deleteAdminRunner = <ThrowOnError extends boolean = false>(options: Options<DeleteAdminRunnerData, ThrowOnError>) => (options.client ?? client).delete<DeleteAdminRunnerResponses, DeleteAdminRunnerErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const getAdminRunner = <ThrowOnError extends boolean = false>(options: Options<GetAdminRunnerData, ThrowOnError>) => (options.client ?? client).get<GetAdminRunnerResponses, GetAdminRunnerErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 * @deprecated
 */
export const adminGetRegistrationToken = <ThrowOnError extends boolean = false>(options?: Options<AdminGetRegistrationTokenData, ThrowOnError>) => (options?.client ?? client).get<AdminGetRegistrationTokenResponses, unknown, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const getOrgRunners = <ThrowOnError extends boolean = false>(options: Options<GetOrgRunnersData, ThrowOnError>) => (options.client ?? client).get<GetOrgRunnersResponses, GetOrgRunnersErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const registerOrgRunner = <ThrowOnError extends boolean = false>(options: Options<RegisterOrgRunnerData, ThrowOnError>) => (options.client ?? client).post<RegisterOrgRunnerResponses, RegisterOrgRunnerErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const deleteOrgRunner = <ThrowOnError extends boolean = false>(options: Options<DeleteOrgRunnerData, ThrowOnError>) => (options.client ?? client).delete<DeleteOrgRunnerResponses, DeleteOrgRunnerErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const getOrgRunner = <ThrowOnError extends boolean = false>(options: Options<GetOrgRunnerData, ThrowOnError>) => (options.client ?? client).get<GetOrgRunnerResponses, GetOrgRunnerErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const getRepoRunners = <ThrowOnError extends boolean = false>(options: Options<GetRepoRunnersData, ThrowOnError>) => (options.client ?? client).get<GetRepoRunnersResponses, GetRepoRunnersErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const registerRepoRunner = <ThrowOnError extends boolean = false>(options: Options<RegisterRepoRunnerData, ThrowOnError>) => (options.client ?? client).post<RegisterRepoRunnerResponses, RegisterRepoRunnerErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const deleteRepoRunner = <ThrowOnError extends boolean = false>(options: Options<DeleteRepoRunnerData, ThrowOnError>) => (options.client ?? client).delete<DeleteRepoRunnerResponses, DeleteRepoRunnerErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const getRepoRunner = <ThrowOnError extends boolean = false>(options: Options<GetRepoRunnerData, ThrowOnError>) => (options.client ?? client).get<GetRepoRunnerResponses, GetRepoRunnerErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const getUserRunners = <ThrowOnError extends boolean = false>(options?: Options<GetUserRunnersData, ThrowOnError>) => (options?.client ?? client).get<GetUserRunnersResponses, GetUserRunnersErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const registerUserRunner = <ThrowOnError extends boolean = false>(options?: Options<RegisterUserRunnerData, ThrowOnError>) => (options?.client ?? client).post<RegisterUserRunnerResponses, RegisterUserRunnerErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const deleteUserRunner = <ThrowOnError extends boolean = false>(options: Options<DeleteUserRunnerData, ThrowOnError>) => (options.client ?? client).delete<DeleteUserRunnerResponses, DeleteUserRunnerErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
 ...
 */
export const getUserRunner = <ThrowOnError extends boolean = false>(options: Options<GetUserRunnerData, ThrowOnError>) => (options.client ?? client).get<GetUserRunnerResponses, GetUserRunnerErrors, ThrowOnError>({
    security: [
        { scheme: 'basic', type: 'http' },
        { name: 'Authorization', type: 'apiKey' },
        {
